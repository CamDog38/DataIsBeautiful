...
export function GoogleAdsMetricsSlide({ slide }: { slide: Slide }) {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center px-10">
      {/* Background */}
      <motion.div
        className="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_30%_30%,rgba(59,130,246,0.35),transparent_50%),radial-gradient(circle_at_70%_70%,rgba(34,197,94,0.25),transparent_50%)]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.4 }}
